...
/*   Updated: 2025/11/05 20:28:03 by maurodri         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace conn {
	...
	public:
		...
		virtual void subscribeFileWrite(
			int fileFd, int clientFd, std::string content) = 0;
		virtual void subscribeCgi(int fileFd, pid_t cgiPid, int clientFd) = 0;
